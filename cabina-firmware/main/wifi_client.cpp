...
#define WIFI_MAXIMUM_RETRY  CONFIG_EXAMPLE_WIFI_MAX_RETRY
                                ...
                                int32_t event_id, void* event_data)
{
    if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) {
        ...
        char ipstr[16];
        ip4addr_ntoa_r((const ip4_addr_t *)&event->ip_info.ip, ipstr, sizeof(ipstr));
        ESP_LOGI(TAG, "Got IP address: %s", ipstr);
        s_retry_num = 0;
        s_connected = true;
